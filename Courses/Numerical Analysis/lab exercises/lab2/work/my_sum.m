function [y, aeb, reb, flag] = l2p1(a)
...
%   2018-11-14   Included calculations for priori error bound aeb.
...
s=aux(1); mu=0; t=0; s_abs = abs(aux(1));
for i=2:n
    % Update the sum
    s=s+aux(i);
    % Update the sum of absolute values
    s_abs = s_abs + abs(aux(i));
